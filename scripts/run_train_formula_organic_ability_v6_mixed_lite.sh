...
cd /mnt/d/百度ocr比赛
OUTPUT_DIR=/mnt/d/百度ocr比赛/output/paddleocr_vl15_formula_organic_ability_v6_mixed_lite_lora_r16_b2ga8_1epoch
case "$OUTPUT_DIR" in
  /mnt/d/百度ocr比赛/output/paddleocr_vl15_formula_organic_ability_v6_mixed_lite_lora_r16_b2ga8_1epoch) rm -rf "$OUTPUT_DIR" ;;
